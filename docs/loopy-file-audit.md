...
| `src/doctor.js` | Local health check orchestrator for package, hooks, docs, vocabulary, comparison scan, model policy, and reviewability. | Enforces native vocabulary, file audits, and advisory model defaults. |
