...
| `src/doctor.js` | `test/doctor.test.js`, `node src/cli.js doctor --json`. | Must verify package, hooks, skill, audit, vocabulary, comparison status, model policy, and reviewability while ignoring generated Codex marketplace install metadata. |
...
| `test/doctor.test.js` | `npm test`. | Must cover doctor checks for package, audit, vocabulary, comparison, design decisions, model policy, generated install metadata, and reviewability. |
