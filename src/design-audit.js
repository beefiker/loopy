...
const REQUIRED_SECTIONS = ["Design Decisions", "Compatibility Boundary", "Native Vocabulary", "Decision Log"];
const REQUIRED_DECISIONS = ["gate-shape-compatibility", "actor-field-policy", "native-naming", "install-reference", "recorded-thresholds"];
